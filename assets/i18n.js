...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "Taşınabilir off-grid (lityum bataryalı) kitler ve tarımsal sulama için hazırladığımız anahtar teslim güneş enerjisi paketleri. Net güç, panel sayısı ve yaklaşık yatırım tutarıyla şeffaf; tek tıkla teklif alın.": "Turnkey solar packages: portable off-grid (lithium battery) kits and agricultural irrigation systems. Transparent — with clear power, panel count and approximate investment; get a quote in one click.",
      "Hazır Çözümler": "Ready Solutions", "Size uygun paketi seçin": "Choose the right package",
      "Taşınabilir off-grid (lityum bataryalı) kitlerden tarımsal sulama paketlerine kadar şebekeden bağımsız, hazır çözümler. Fiyatlar yaklaşık başlangıç değerleridir; kesin tutar ücretsiz keşifle belirlenir.": "Off-grid, ready-made solutions — from portable lithium-battery kits to agricultural irrigation packages. Prices are approximate starting values; the exact figure is set during a free site survey.",
      ...
      "Hangi kapasiteyi seçmeliyim?": "Which capacity should I choose?", "Hane halkı sayısına göre 60–150 L modeller mevcuttur. 1–2 kişi için 60–80 L, 3–4 kişi için 100–120 L, 5+ kişi için 150 L önerilir.": "Models from 60–150 L are available by household size. 60–80 L for 1–2 people, 100–120 L for 3–4, 150 L for 5+.",
    ...
    de: {
      ...
      "Taşınabilir off-grid (lityum bataryalı) kitler ve tarımsal sulama için hazırladığımız anahtar teslim güneş enerjisi paketleri. Net güç, panel sayısı ve yaklaşık yatırım tutarıyla şeffaf; tek tıkla teklif alın.": "Schlüsselfertige Solar-Pakete: tragbare Off-Grid-Sets (Lithium-Batterie) und landwirtschaftliche Bewässerung. Transparent — mit klarer Leistung, Modulanzahl und ungefährer Investition; Angebot mit einem Klick.",
      "Hazır Çözümler": "Fertige Lösungen", "Size uygun paketi seçin": "Wählen Sie Ihr Paket",
      "Taşınabilir off-grid (lityum bataryalı) kitlerden tarımsal sulama paketlerine kadar şebekeden bağımsız, hazır çözümler. Fiyatlar yaklaşık başlangıç değerleridir; kesin tutar ücretsiz keşifle belirlenir.": "Netzunabhängige Fertiglösungen — von tragbaren Lithium-Batterie-Sets bis zu Bewässerungspaketen. Preise sind ungefähre Startwerte; der genaue Betrag wird bei der kostenlosen Begehung ermittelt.",
      ...
      "Hangi kapasiteyi seçmeliyim?": "Welche Kapazität soll ich wählen?", "Hane halkı sayısına göre 60–150 L modeller mevcuttur. 1–2 kişi için 60–80 L, 3–4 kişi için 100–120 L, 5+ kişi için 150 L önerilir.": "Modelle von 60–150 L je nach Haushaltsgröße. 60–80 L für 1–2 Personen, 100–120 L für 3–4, 150 L für 5+.",
    ...
    ru: {
      ...
      "Taşınabilir off-grid (lityum bataryalı) kitler ve tarımsal sulama için hazırladığımız anahtar teslim güneş enerjisi paketleri. Net güç, panel sayısı ve yaklaşık yatırım tutarıyla şeffaf; tek tıkla teklif alın.": "Готовые солнечные пакеты: портативные off-grid комплекты (литиевый аккумулятор) и системы аграрного полива. Прозрачно — понятная мощность, число панелей и примерная стоимость; КП в один клик.",
      "Hazır Çözümler": "Готовые решения", "Size uygun paketi seçin": "Выберите подходящий пакет",
      "Taşınabilir off-grid (lityum bataryalı) kitlerden tarımsal sulama paketlerine kadar şebekeden bağımsız, hazır çözümler. Fiyatlar yaklaşık başlangıç değerleridir; kesin tutar ücretsiz keşifle belirlenir.": "Автономные готовые решения — от портативных комплектов с литиевым аккумулятором до пакетов для полива. Цены ориентировочны; точная сумма определяется при бесплатном выезде.",
      ...
      "Hangi kapasiteyi seçmeliyim?": "Какую ёмкость выбрать?", "Hane halkı sayısına göre 60–150 L modeller mevcuttur. 1–2 kişi için 60–80 L, 3–4 kişi için 100–120 L, 5+ kişi için 150 L önerilir.": "Доступны модели 60–150 л по числу жильцов. 60–80 л для 1–2 человек, 100–120 л для 3–4, 150 л для 5+.",

...
(function () {
  ...
  Object.assign(DICT.en, {
    ...
    "Gespa Enerji, Antalya merkezli havuz teknolojileri firmasıdır. Otellere havuz ısıtma çözümleri sunan ekibimiz, şimdi aynı mühendislik disiplinini havuz güvenliğine taşıyor. Uluslararası boğulma tespit sistemi üreticileriyle distribütörlük ve yetkili servis süreçlerimiz yürütülmektedir; tüm kurulumlar sertifikalı ekiplerce yapılır ve yerinde kabul testleriyle teslim edilir.": "Gespa Enerji is an Antalya-based pool technology company. Our team, already serving hotels with pool heating solutions, now brings the same engineering discipline to pool safety. Distributorship and authorised-service processes with international drowning-detection manufacturers are underway; every installation is carried out by certified crews and delivered with on-site acceptance tests.",
    ...
    "Evet. Çoğu projede havuz boşaltılmadan, işletme aksatılmadan kurulum yapılabilir; sualtı aydınlatması olan havuzlarda süreç daha da hızlıdır. Kesin yöntem ücretsiz keşifte belirlenir.": "Yes. In most projects installation is possible without draining the pool or interrupting operations; pools with underwater lighting are even faster. The exact method is determined during the free site survey.",
  ...
  Object.assign(DICT.de, {
    ...
    "Gespa Enerji, Antalya merkezli havuz teknolojileri firmasıdır. Otellere havuz ısıtma çözümleri sunan ekibimiz, şimdi aynı mühendislik disiplinini havuz güvenliğine taşıyor. Uluslararası boğulma tespit sistemi üreticileriyle distribütörlük ve yetkili servis süreçlerimiz yürütülmektedir; tüm kurulumlar sertifikalı ekiplerce yapılır ve yerinde kabul testleriyle teslim edilir.": "Gespa Enerji ist ein Pool-Technologie-Unternehmen mit Sitz in Antalya. Unser Team, das Hotels bereits mit Poolheizungslösungen versorgt, bringt dieselbe Ingenieursdisziplin nun in die Poolsicherheit. Distributions- und Serviceprozesse mit internationalen Herstellern von Ertrinkungserkennungssystemen laufen; jede Installation erfolgt durch zertifizierte Teams mit Abnahmetests vor Ort.",
    ...
    "Evet. Çoğu projede havuz boşaltılmadan, işletme aksatılmadan kurulum yapılabilir; sualtı aydınlatması olan havuzlarda süreç daha da hızlıdır. Kesin yöntem ücretsiz keşifte belirlenir.": "Ja. In den meisten Projekten ist die Installation ohne Entleeren des Beckens und ohne Betriebsunterbrechung möglich; bei Becken mit Unterwasserbeleuchtung geht es noch schneller. Die genaue Methode wird bei der kostenlosen Vor-Ort-Analyse festgelegt.",
  ...
  Object.assign(DICT.ru, {
    ...
    "Gespa Enerji, Antalya merkezli havuz teknolojileri firmasıdır. Otellere havuz ısıtma çözümleri sunan ekibimiz, şimdi aynı mühendislik disiplinini havuz güvenliğine taşıyor. Uluslararası boğulma tespit sistemi üreticileriyle distribütörlük ve yetkili servis süreçlerimiz yürütülmektedir; tüm kurulumlar sertifikalı ekiplerce yapılır ve yerinde kabul testleriyle teslim edilir.": "Gespa Enerji — компания из Антальи в сфере технологий для бассейнов. Наша команда, уже поставляющая отелям решения по подогреву бассейнов, переносит ту же инженерную дисциплину в безопасность на воде. Идут процессы дистрибуции и авторизованного сервиса с международными производителями систем обнаружения утопления; все монтажи выполняют сертифицированные бригады с приёмочными испытаниями на месте.",
    ...
    "Evet. Çoğu projede havuz boşaltılmadan, işletme aksatılmadan kurulum yapılabilir; sualtı aydınlatması olan havuzlarda süreç daha da hızlıdır. Kesin yöntem ücretsiz keşifte belirlenir.": "Да. В большинстве проектов монтаж возможен без слива воды и без остановки работы; в бассейнах с подводной подсветкой процесс ещё быстрее. Точный метод определяется при бесплатном выезде.",

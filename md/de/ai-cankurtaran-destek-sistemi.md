---
title: "KI-Assistenz für Rettungsschwimmer — Poolsicherheit"
...
[Startseite](https://www.gespaenerji.com/de/) / Neue Technologien / KI-Rettungsschwimmer-Assistenzsystem
...
[Kostenlose Vor-Ort-Analyse & Pilotangebot anfordern](#teklif)
[▶ System in Aktion ansehen](#canli)
...
Die Boxen zeigen die einzeln verfolgten Schwimmer. Die Aufnahmen werden auf einem lokalen Server im Objekt verarbeitet; nichts geht in die Cloud.

Wie funktioniert es?

## Wie funktioniert das Ertrinkungspräventionssystem — in drei Schritten?
...
Schematische Live-Darstellung; die echte Erkennungsaufnahme sehen Sie im Video oben.

Arbeitet zusammen

## Rettungsschwimmer oder System? Beide — gemeinsam.
...
## Ertrinken ist nicht laut wie im Film. Es ist still.
...
Weltweit gehört Ertrinken zu den häufigsten Todesursachen bei Kindern von 1-4 Jahren.

Die Aufsicht durch Rettungsschwimmer ist unverzichtbar; doch das menschliche Auge hat physiologische Grenzen: Blendung, Spiegelungen, Gedränge und Ermüdung.

Technologie schließt diese Lücken: ein unermüdliches zusätzliches Auge, das das gesamte Becken überwacht.

Die Lage in der Türkei

## Das Risiko ist nicht weit — Antalya führt bei Pool-Ertrinkungsfällen
...
**%29**Antalyas Anteil an allen Pool-Ertrinkungsfällen 2011–2016 — Platz eins unter den Provinzen (28 Personen)

**96**Gesamtzahl der in Pools ums Leben gekommenen Personen im Sechsjahreszeitraum

**2**Tödliche Hotelpool-Vorfälle, über die in der Saison 2026 berichtet wurde (Juli, Alanya)

**4–8**Altersspanne der bei den Vorfällen 2026 verstorbenen Kinder
...
### Unzureichende Rettungsschwimmer-Besetzung
...
**🛟 Welche dieser Lücken schließt das System?**
...
## Ein einziger Vorfall kann weit mehr kosten als den Gewinn einer Saison

Ein einziger tödlicher Vorfall im Pool ist für ein Hotel nicht nur eine Krise dieses einen Tages:

- **Strafverfahren:** In türkischen Fällen bleibt die Verantwortung nicht auf den Rettungsschwimmer beschränkt; auch gegen Geschäftsführer, Sicherheitschefs und Arbeitsschutzexperten kann wegen fahrlässiger Tötung ermittelt werden.
- **Schadensersatzklagen:** Verfahren um materiellen und immateriellen Schadensersatz können sich über Jahre hinziehen und binden das Management.
- **Behördliche Sanktionen:** Während der Ermittlungen kann der Betrieb des Pools oder der Anlage eingeschränkt werden.
- **Dauerhafter Reputationseintrag:** Berichte über den Vorfall bleiben jahrelang zusammen mit dem Namen des Hauses in Suchergebnissen sichtbar und beeinflussen Agentur- und Gästeentscheidungen.
- **Teamverlust:** Das Trauma des betroffenen Rettungsschwimmers und Teams kann mitten in der Saison zu Personalverlust führen.
...
Das System aus der Nähe

## Tag und Nacht, ein Pool oder die ganze Anlage
...
### Die ganze Anlage auf einer Plattform
...
### Der Alarm kommt ans Handgelenk
...
## Schlägt das System grundlos Alarm? Zwei Funktionen minimieren Fehlalarme.
...
## Von Hotelpool-Sicherheit bis zum Aquapark-Sicherheitssystem — für jede stark besuchte Anlage
...
- Analyse, Planung, Installation und Wartung aus einer Hand
- Schulung Ihres Rettungsschwimmer-Teams vor Ort
- Periodische Testprotokolle nach ISO 20380:2017
- Datenschutz: Aufnahmen verlassen die Anlage nicht, Verarbeitung auf lokalem Server
...
**45+**Anlageninstallationen

**3 Kontinente**Asien · Afrika · internationale Projekte

**19 Städte**in verschiedenen Klimazonen und Pooltypen

**5★**inkl. internationaler Hotelketten
...
## Konformität, per Dokumentnummer überprüfbar
...
Belegt, dass das elektromagnetische Feld des Geräts in gesundheitlich unbedenklichen Grenzen bleibt.

Bericht-Nr.: CHTW25100048 · Ergebnis: bestanden

### EN IEC 62368-1

Der Test, der die elektrische Sicherheit des Geräts belegt.

Bericht-Nr.: CHTE25100104

### ISO 20380:2017

Der internationale Standard für kamerabasierte Ertrinkungserkennung in Pools. Auch dieser Standard definiert das System als Unterstützung des Rettungsschwimmers — nicht als Ersatz.

Konforme Technologie

### Datenschutz-Konformität

Aufnahmen werden auf einem lokalen Server in der Anlage verarbeitet; keine Übertragung in die Cloud oder ins Ausland.

Datenschutzhinweis und Aufbewahrungsrichtlinie werden mit der Installation übergeben

Kopien der Dokumente werden auf Anfrage an Unternehmen weitergegeben.

Nachweisakte

## Ihre Sorgfaltspflicht — jetzt dokumentiert
...
- **Zeitgestempelte Alarmaufzeichnungen:** Jeder Alarm wird mit Uhrzeit, Position im Becken und Bildmaterial gespeichert.
- **Tägliche Betriebsberichte:** Personenzahl-Statistiken und die Postenverfolgung der Rettungsschwimmer werden ans Management-Panel gemeldet.
- **Periodische Testprotokolle:** Regelmäßige Funktionstests werden im Rahmen von ISO 20380:2017 durchgeführt und dokumentiert.
...
- **Einmaliger Kauf** — Das System wird schlüsselfertig installiert; die Hardware gehört Ihnen.
- **monatlichen Sicherheitsservice** — Nach der Installationsgebühr eine fixe Monatsrate: Hardware, Software, Wartung und Support in einem Paket. **Ab 299 USD /Monat**, Zahlungsoptionen bis zu 36 Monaten.

Was passt zu Ihrer Anlage? Nach der kostenlosen Begehung erhalten Sie beide Optionen als schriftliches Angebot.

Einmalzahlung oder Pläne bis 36 Monate
Software-Abo für das 1. Jahr inklusive
Hardware-Erneuerungsgarantie bei der Mietoption

[Zahlungsplan für Ihre Anlage anfordern](#teklif)

**2026 Launch-Programm:**
Launch-Konditionen und der lebenslang feste Servicesatz gelten nur für die ersten **5** Vertragsobjekte begrenzt. 2027 Saison-Installationsplätze können jetzt reserviert werden.
[Kontingent sichern →](#teklif)
...
## Kostenlose Vor-Ort-Analyse und Pilotangebot für Ihre Anlage
...
---
Kaynak sayfa: https://www.gespaenerji.com/de/ai-cankurtaran-destek-sistemi.html · GESPA Enerji · 0543 743 42 09 · info@gespaenerji.com · Örnek Mah. 1551 Sok. Yaşar Apt. No:10 İç Kapı No: Z01, Manavgat / Antalya

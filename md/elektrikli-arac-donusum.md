---
title: "Elektrikli Araç Güneş Dönüşümü — BOOST MPPT | GESPA"
...
Ön görünüm — panel (+/−), IN/OUT anahtar girişi ve akü (−/+) klemensleri

🔌 Şarj Kontrol Cihazı

# MS Teknik BOOST MPPT 24-72 V Şarj Kontrol Cihazı

Ürün kodu: **GES-EV-BOOST** Stokta / tedarikte
...
- 🔧 Antalya bölgesinde isteğe bağlı yerinde kurulum: panel montajı, kablolama ve cihaz ayarı ekibimizce yapılır.

⚙️ 24 – 72 V akü 🔋 AGM · jel · kurşun-asit · lityum 📶 Bluetooth ile ayar ⚡ 15 A sürekli çıkış 🛡️ IP22 · 2 yıl garanti
...
### Bluetooth ile programlanabilir
...
## Aracınıza hangi panel uyar?

Çoğu müşteri hangi panelin aracına sığacağını bilmiyor. Aracınızın tipini seçin; uygun panel, şarj kontrol cihazı ve bağlantı malzemeleri hazır paket olarak çıksın.

### Yolcu Kabinli Motor Güneş Paketi — 285 W

Kabinli, 2–4 kişilik yolcu araçları — çatı alanı dar

- Lexron 285 W Güneş Paneli
- MS Teknik BOOST MPPT 24-72 V Şarj Kontrol Cihazı
- Solar Kablo Takımı (5 m Siyah + 5 m Kırmızı)
- MC4 Konnektör Takımı

Set toplamı : **₺15.800** · KDV dahil · kargo hariç

[Ürün sayfası](https://www.gespaenerji.com/paket-motor-yolcu.html)

### Kargo Kasalı Motor Güneş Paketi — 655 W

Açık kasa veya tenteli yük araçları — çatı alanı geniş

- Lexron 655 W TOPCon Güneş Paneli
- MS Teknik BOOST MPPT 24-72 V Şarj Kontrol Cihazı
- Solar Kablo Takımı (5 m Siyah + 5 m Kırmızı)
- MC4 Konnektör Takımı
...
🔋 AGM · jel · kurşun-asit · lityum
📶 Bluetooth ile programlanabilir
⚙️ 24V – 72V akü sistemleri
☀️ Panelden doğrudan şarj

![Güneş panelli elektrikli golf aracı ve BOOST MPPT Charger](https://www.gespaenerji.com/assets/img/products/ev/ev-solar-banner.webp)

⚡ Elektrikli Araç Dönüşümü

## Temiz enerji, daha özgür yarınlar
...
- Park hâlinde kendi kendine şarj
- Şebekeden çekilen şarj miktarında azalma
- Lityum akü paketine uygun şarj profili
- Bluetooth üzerinden ayar ve izleme

[Teklif Al](https://www.gespaenerji.com/iletisim.html)

Nasıl Çalışır?

## Panelden tekerleğe 4 adım

Zincir basittir: güneş üretir, kontrol cihazı yönetir, akü depolar, araç kullanır.

- 1 ### Güneş Paneli Aracın tavanına ya da üst platformuna yerleştirilen panel, gün boyu doğru akım üretir.
- 2 ### BOOST MPPT Charger Panel gerilimini akü paketinin seviyesine yükseltir; MPPT algoritmasıyla o anki ışıkta çekilebilecek en yüksek gücü çeker.
- 3 ### Lityum Akü Şarj akımı, akü paketine kontrollü biçimde aktarılır. Ayarlar paketin değerlerine göre programlanır.
- 4 ### Elektrikli Araç Araç aynı akü paketinden beslenmeye devam eder; şebekeden şarj ihtiyacı azalır.

Kurulum

## Dönüşümü biz yapıyoruz
...
- Araç ve akü paketi üzerinde ön inceleme
- Panel yerleşimi ve gölgelenme değerlendirmesi
- Kontrol cihazının montajı ve kablolama
- Bluetooth üzerinden şarj ayarlarının yapılması
- Teslimde çalışır hâlde test ve kullanım anlatımı

[Ücretsiz Keşif İste](https://www.gespaenerji.com/iletisim.html)

Kimler İçin?

## Hangi araçlara uygulanıyor?
...
## Aracınıza uygun mu, birlikte bakalım
...
---
Kaynak sayfa: https://www.gespaenerji.com/elektrikli-arac-donusum.html · GESPA Enerji · 0543 743 42 09 · info@gespaenerji.com · Örnek Mah. 1551 Sok. Yaşar Apt. No:10 İç Kapı No: Z01, Manavgat / Antalya

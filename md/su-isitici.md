---
title: "PV Güneş Enerjili Su Isıtıcı 60–200 L | GESPA Enerji"
...
[Ana Sayfa](https://www.gespaenerji.com/) / Solar Su Isıtıcı
...
Güncel fiyat için bize ulaşın [modelleri gör →](#modeller)

💧 60–200 L kapasite
↔️ Yatay & dikey modeller
🛡️ Emaye iç tank
🏅 TÜV • CE • UL • UN38.3

🔆 Yeni Nesil Ürün

## Güneşle bedava sıcak su
...
- Donma, aşırı ısınma ve kuru çalışma korumaları

[Teklif Al](https://www.gespaenerji.com/iletisim.html)

Ürün Galerisi

## Tankı her açıdan inceleyin
...
![Yatay PV su ısıtıcı — ön görünüm, bağlantı portları ve kontrol paneli](https://www.gespaenerji.com/assets/img/products/heater/tank-1.webp)

Ön görünüm — bağlantı portları ve dokunmatik kontrol paneli

![Dokunmatik kontrol paneli yakın plan](https://www.gespaenerji.com/assets/img/products/heater/detay-kontrol.webp)

### Dokunmatik kontrol paneli

Sıcaklık ayarı, ısıtma modu ve zaman programı tek panelden. Hata kodları ekranda görünür.

![Sıcak su çıkışı, soğuk su girişi ve tahliye portu](https://www.gespaenerji.com/assets/img/products/heater/detay-portlar.webp)

### Standart su bağlantıları

Sıcak su çıkışı, soğuk su girişi ve tahliye portu etiketli; emniyet ventili hortumu takılı gelir.

![Rezistans ve anot servis kapağı](https://www.gespaenerji.com/assets/img/products/heater/detay-flans.webp)
...
## 3 adımda bedava sıcak su

Fotovoltaik panel elektriği doğrudan su ısıtıcısına aktarır — basit, güvenli ve verimli.

- 1 ### Fotovoltaik Modül Monokristal panel güneş ışığını elektriğe çevirir.
- 2 ### Su Isıtıcı Tank Emaye iç tank, poliüretan yalıtımla ısıyı korur.
- 3 ### Sıcak Su Kullanımı Banyo, mutfak — tüm ev için kesintisiz sıcak su.

**☁️ Bulutlu / yağmurlu havalarda ne olur?**
...
- PV + AC hibrit ısıtma yönetimi
- Programlanabilir akıllı mod
- Anlık (hızlı) ısıtma
- 0–90°C ölçüm · 35–75°C ayar
- Donma & kuru çalışma koruması
- Aşırı ısınma koruması (E5)
...
- 1–2 kişi 60–80 L Tek kişi, çift ya da yazlık kullanım
- 3–4 kişi 100–120 L Günde 2–3 duş, mutfak kullanımı
- 5+ kişi 150–200 L Kalabalık aile, arka arkaya duş
...
## Keşiften sıcak suya 4 adım

Tipik bir konut kurulumu aynı gün içinde tamamlanır.

![Bağlantı şeması: çatıdaki güneş paneli iki damarlı DC kabloyla banyodaki termosifonun klemensine bağlanır; klemenste PV artı, PV eksi, AC faz ve nötr uçları, tankta sıcak su çıkışı ve soğuk su girişi bulunur.](https://www.gespaenerji.com/assets/img/products/heater/baglanti-semasi.webp)

Panel çatıda veya balkonda, tank iç mekânda durur; aralarında yalnızca iki damarlı DC kablo geçer — su panele hiç çıkmaz, bu yüzden donma ve kireçlenme riski yoktur. Büyütmek için görsele tıklayın.

- 1 ### Ücretsiz keşif Çatı/teras yönü, mevcut tesisat ve hane halkı ihtiyacına göre kapasite belirlenir.
- 2 ### Tank ve panel montajı Tank taşıyıcı yüzeye sabitlenir, panel gölgesiz yöne uygun açıyla kurulur.
- 3 ### Su ve DC bağlantısı Soğuk su girişi, sıcak su çıkışı ve emniyet ventili bağlanır; panel kablosu kontrol cihazına çekilir.
- 4 ### Devreye alma Tank doldurulur, sızdırmazlık ve ısıtma testi yapılır, kullanım anlatılır.

🛡️ Tank Teknolojisi

## Sağlıklı sıcak suyun sırrı

Korozyona ve kirece dayanıklı iç tank; uzatılmış ve kalınlaştırılmış magnezyum anot ile uzun ömür.

- Baosteel özel emaye çelik plaka
- Yüksek mukavemetli yapıştırıcı katman
- Blue Gold Steel emaye alt sır
- Emaye güçlendirme katmanı
- Kir tutmaz, kireçlenme yapmaz
- Antibakteriyel iç yüzey
- Poliüretan yüksek yoğunluklu yalıtım
- Magnezyum anot ile uzun ömür
...
- Kişiye özel proje tasarımı
- Yüksek verimli monokristal panel
- Sertifikalı kalite süreçleri

Neden GESPA?

## Alım öncesi ve sonrası yanınızdayız
...
## Kurulumdan sonra ne yapmanız gerekir?
...
## Eviniz için doğru modeli birlikte seçelim
...
---
Kaynak sayfa: https://www.gespaenerji.com/su-isitici.html · GESPA Enerji · 0543 743 42 09 · info@gespaenerji.com · Örnek Mah. 1551 Sok. Yaşar Apt. No:10 İç Kapı No: Z01, Manavgat / Antalya

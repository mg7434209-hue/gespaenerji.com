---
title: "AI Cankurtaran Destek Sistemi — Havuz Güvenliği | GESPA"
...
[Ücretsiz Keşif ve Pilot Teklifi Alın](#teklif)
[▶ Sistemi çalışırken izleyin](#canli)
...
Kutular, sistemin ayrı ayrı takip ettiği yüzücüleri gösterir. Görüntüler tesis içindeki yerel sunucuda işlenir; buluta gönderilmez.

Nasıl çalışır?

## Havuz boğulma önleme sistemi üç adımda nasıl çalışır?
...
Şematik canlı gösterimdir; gerçek tespit kaydı için yukarıdaki videoya bakın.

Birlikte çalışır

## Cankurtaran mı, sistem mi? İkisi birlikte.
...
## Boğulma, filmlerdeki gibi gürültülü değildir. Sessizdir.
...
Dünya genelinde boğulma, 1-4 yaş arası çocuklarda önde gelen ölüm nedenlerindendir.

Cankurtaran gözetimi vazgeçilmezdir; ancak insan gözünün de fizyolojik sınırları vardır: parlama, yansıma, kalabalık ve yorgunluk.

Teknoloji bu sınırları kapatmak için var: havuzun tamamını hiç yorulmadan izleyen bir ek göz.

Türkiye tablosu

## Risk uzakta değil — Antalya, havuz boğulmalarında ilk sırada
...
**%29**2011–2016 arasında tüm havuz boğulmalarının Antalya payı — iller arasında birinci (28 kişi)

**96**Altı yıllık dönemde havuzlarda hayatını kaybeden toplam kişi sayısı

**2**2026 sezonunda basına yansıyan ölümlü otel havuzu vakası (Temmuz, Alanya)

**4–8**2026 vakalarında hayatını kaybeden çocukların yaş aralığı
...
**🛟 Sistem bu boşlukların hangisini kapatır?**
...
## Tek bir olay, bir sezonluk kazancın çok ötesine mal olabilir

Havuzda yaşanan ölümlü tek bir vaka, bir otel için yalnızca o güne ait bir kriz değildir:

- **Adli süreç:** Türkiye'deki vakalarda sorumluluk cankurtaranla sınırlı kalmıyor; genel müdür, güvenlik müdürü ve iş güvenliği uzmanı hakkında da taksirle ölüme neden olma isnadıyla işlem yapılabiliyor.
- **Tazminat davaları:** Maddi ve manevi tazminat süreçleri yıllarca sürebilir ve yönetimin gündemini işgal eder.
- **İdari yaptırım riski:** Soruşturma süresince havuzun veya tesisin faaliyetinin kısıtlanması gündeme gelebilir.
- **Kalıcı itibar kaydı:** Olay haberleri arama sonuçlarında tesisin adıyla birlikte yıllarca görünür kalır; acente ve misafir kararlarını uzun süre etkileyebilir.
- **Ekip kaybı:** Olayı yaşayan cankurtaran ve operasyon ekibinin travması, sezon ortasında personel kaybına dönüşebilir.
...
## Gece, gündüz, tek havuz veya tüm tesis
...
## Sistem boş yere alarm verir mi? Bunu en aza indiren iki özellik var.

🎯

### Boş alarmları en aza indirir
...
## Otel havuz güvenliğinden aquapark güvenlik sistemine — her yoğun tesis için
...
- Keşif, projelendirme, kurulum ve bakım tek elden
- Cankurtaran ekibinize yerinde kullanım eğitimi
- ISO 20380:2017 çerçevesinde periyodik test protokolleri
- KVKK uyumu: görüntüler tesis dışına çıkmaz, yerel sunucuda işlenir
...
**3 kıta**Asya · Afrika · uluslararası projeler

**19 şehir**farklı iklim ve havuz tiplerinde

**5★**uluslararası otel zincirleri dahil
...
## Numarasıyla doğrulanabilir uygunluk
...
Cihazın yaydığı elektromanyetik alanın insan sağlığı için güvenli sınırlarda olduğunu gösterir.

Rapor No: CHTW25100048 · Sonuç: Geçti (Pass)

### EN IEC 62368-1

Cihazın elektriksel olarak güvenli olduğunu gösteren test.

Rapor No: CHTE25100104

### ISO 20380:2017

Havuzlarda kamerayla boğulma tespitinin uluslararası standardı. Bu standart da sistemi cankurtarana destek olarak tanımlar — yerine geçen bir çözüm olarak değil.

Uyumlu teknoloji

### KVKK uyumu

Görüntüler tesis içindeki yerel sunucuda işlenir; buluta veya yurt dışına aktarılmaz.

Aydınlatma metni ve kayıt politikası kurulumla birlikte teslim edilir

Belgelerin kopyaları talep üzerine kurumsal olarak paylaşılır.

İspat dosyası

## Özen yükümlülüğünüz artık kayıt altında
...
- **Zaman damgalı uyarı kayıtları:** Her alarm; saati, havuz içi konumu ve görüntüsüyle birlikte saklanır.
- **Günlük operasyon raporları:** Kişi sayısı istatistikleri ve cankurtaran görev noktası takibi yönetim paneline raporlanır.
- **Periyodik test protokolleri:** ISO 20380:2017 çerçevesinde düzenli işlev testleri yapılır ve kayda geçirilir.
...
## Tek seferde satın almak zorunda değilsiniz.

İki seçenek var:

- **Tek seferlik satın alma** — Sistem anahtar teslim kurulur; donanım sizindir.
- **Aylık Güvenlik Hizmeti** — Kurulum bedeli sonrası aylık sabit ücret: donanım, yazılım, bakım ve destek tek pakette. **Aylık 299 USD 'den başlayan planlar**, 36 aya varan ödeme seçenekleri.

Hangisi tesisinize uygun? Ücretsiz keşif sonrası iki seçeneği de yazılı teklif olarak sunarız.

Peşin veya 36 aya varan planlar
1. yıl yazılım aboneliği dahil
Kiralama seçeneğinde donanım yenileme güvencesi

[Tesisiniz İçin Ödeme Planı Alın](#teklif)

**2026 Lansman Programı:**
Lansman koşulları ve ömür boyu sabit servis oranı, sözleşme imzalayan ilk **5** tesisle sınırlıdır. 2027 sezonu için kurulum sırası şimdiden ayrılabilir.
[Kontenjan ayırt →](#teklif)
...
## Tesisiniz için ücretsiz keşif ve pilot teklifi
...
---
Kaynak sayfa: https://www.gespaenerji.com/ai-cankurtaran-destek-sistemi.html · GESPA Enerji · 0543 743 42 09 · info@gespaenerji.com · Örnek Mah. 1551 Sok. Yaşar Apt. No:10 İç Kapı No: Z01, Manavgat / Antalya
